...
class TestDatabase(unittest.TestCase):
    ...
    def test_get_author_statistics_detailed(self):
        ...
        self.assertEqual(data[0], 5, "The number of overall publications of author A is not right")
        self.assertEqual(data[1], 2, "The number of publications of author A as first is not right")
        self.assertEqual(data[2], 1, "The number of publications of author A as last is not right")
        self.assertEqual(data[3], 1, "The number of publications of author A as sole is not right")
        self.assertEqual(data[4], 3, "The number of co-authors of author A is not right")
        # Testing inproceedings (0) for author B (1)
        data = db.get_author_statistics_detailed(0, 0)
        self.assertEqual(data[0], 2, "The number of overall conference papers of author B is not right")
        self.assertEqual(data[1], 0, "The number of conference papers of author B as first is not right")
